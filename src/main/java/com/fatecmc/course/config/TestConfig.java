package com.fatecmc.course.config;
...
import com.fatecmc.course.entities.Payment;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		o1.setPayment(pay1);
		orderRepository.save(o1);//apos setar um pagamento para um pedido, vc salva novamente e o JPS vai Salvar pedido no banco.
	}
}
